...
const envFileTemplate = `# Inkless CMS Configuration
# Generated by Inkless setup
...
func DefaultEnvFilePath() string {
	if p := brandcompat.EnvValue(brandcompat.EnvFileVariable, brandcompat.LegacyEnvFileVariable); p != "" {
		return p
	}
	return ".env"
}
