...
func (h *Handler) AdminCreate(c *gin.Context) {
	...
	// Theme-declared slugs (features, home, …) are allowed: Page is the data
	// record for that shell (ADR-0002 appendix D/F). Only reserved Host paths
	// and duplicate slugs are rejected.
