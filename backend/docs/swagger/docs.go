...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_handler_agent.WhoamiResponse"
                        }
                    },
                    "401": {
        ...
        "/admin/content/{pageKey}/draft": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Page key (home, contact, …)",
                        "name": "pageKey",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Expected draft version",
                        "name": "If-Match",
                        "in": "header",
                        "required": true
                    },
        ...
        "/admin/content/{pageKey}/rollback/{version}": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Source published version",
                        "name": "version",
                        "in": "path",
                        "required": true
                    },
    ...
    "definitions": {
        ...
        "github_com_yixian-huang_inkless_backend_internal_service.TranslationState": {
            "type": "string",
            "enum": [
                "done",
                "missing",
        ...
        "github_com_yixian-huang_inkless_backend_internal_service.ValidationError": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "internal_handler_agent.WhoamiCapabilities": {
            "type": "object",
            "properties": {
                "aiArticleMeta": {
                    "description": "articles:update (article-meta endpoint)",
                    "type": "boolean"
                },
                "articles": {
                ...
                "pages": {
                    "description": "pages:read (unified /admin/pages)",
                    "type": "boolean"
                },
                "publish": {
                    "description": "articles:publish or pages:publish",
                    "type": "boolean"
                },
                "themeContent": {
                    "description": "ThemeContent is true when the agent can use theme-bound content_documents\nAdmin API (/admin/content/:pageKey/*). Gated by pages:read (same as content GET draft).",
                    "type": "boolean"
                },
                "themeContentKeys": {
                    "description": "ThemeContentKeys lists writable/readable content pageKeys (agent discovery).",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "internal_handler_agent.WhoamiResponse": {
            "type": "object",
            "properties": {
                "apiKeyId": {
                    "type": "integer"
                ...
                "capabilities": {
                    "$ref": "#/definitions/internal_handler_agent.WhoamiCapabilities"
                },
                "permissions": {
                    "type": "array",
                    "items": {
                ...
                "scopes": {
                    "description": "empty for session JWT",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "user": {
                    "$ref": "#/definitions/internal_handler_agent.WhoamiUser"
                },
                "version": {
                    "type": "string"
                }
        ...
        "internal_handler_agent.WhoamiUser": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer"
        ...
        "internal_handler_content.ValidateResponse": {
            ...
            "properties": {
                "errors": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_yixian-huang_inkless_backend_internal_service.ValidationError"
                    }
                },
                "schemaKind": {
                    "type": "string"
                ...
                "translationStatus": {
                    ...
                    "additionalProperties": {
                        "$ref": "#/definitions/github_com_yixian-huang_inkless_backend_internal_service.TranslationState"
                    }
                },
                "valid": {
                    "type": "boolean"
