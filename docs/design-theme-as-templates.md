...
| 字段 | 值 |
|------|-----|
| 状态 | **T1–T5 done** — Page SSOT, thin theme shells, docs drop production content write |
| 日期 | 2026-08-01 |
...
| **T5** | 硬编码 pages[] 薄壳化 / 文档删除生产 content 写路径 | **done**（本迭代） |

**T1–T5 已落地 MVP**：Page 为运营真源；主题 `pages[]` 为显示壳；`content *` / content_documents 仅迁移与 dual-read。
