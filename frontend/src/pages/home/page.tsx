            ...
            {coreServices.items && coreServices.items.length > 0 && (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                {coreServices.items.map((service, index) => (
                  <div key={index} className="flex flex-col rounded-lg overflow-hidden bg-white shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                    <div className="w-full h-[160px] sm:h-[180px] flex-shrink-0 overflow-hidden bg-gray-50">
                      <img
