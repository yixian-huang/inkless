  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: (
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12a7.5 7.5 0 0112.75-5.303L19.5 9m0 0V4.5M19.5 9H15M19.5 12a7.5 7.5 0 01-12.75 5.303L4.5 15m0 0v4.5M4.5 15H9" />
          </svg>
        ),
      },
    ],
